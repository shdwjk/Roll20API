...
const ColorNote = (() => {  // eslint-disable-line no-unused-vars
  ...
  let subRolls=processInlinerolls;
  ...
  const checkInstall = function(){
    ...
    if('undefined' !== typeof libInline && 'function' === typeof libInline.getRollData){
      subRolls = (msg) => {
        let pir = libInline.getRollData(msg);
        return msg.content.replace(/\$\[\[(\d+)]]/g, ((m, g1) => pir[g1].getRollTip()));
      };
    } 
  };
